...
public class CanceledFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayout itemContainer = (LinearLayout) view.findViewById(R.id.canceled_layout);
